...
import numpy as np
from . import gridding, io, linalg, noise, optimize, sparse, utils
...
def corrcal_pipe(
    ...
    noise_model: str or path-like object, optional
        ...
        For details on built-in noise models, see :module:`noise`.
...
def corrcal_run(
    ...
    algorithm: str, optional
        Name of an optimization algorithm. See :module:`optimize` for
